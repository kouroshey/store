...
const CardSlide = ({ title, img, url, desc, subtitle, buttonStyle, btnUrl }) => {
  ...
  return (
    <div className="w-full h-[30rem] flex flex-col items-center lg:flex-row  lg:justify-around">
      <div className=" h-full flex-col gap-8  hidden justify-center lg:flex">
        ...
        <Button buttonStyle={buttonStyle} text={'SHOP NOW'} btnUrl={btnUrl} isLink={true} url={url} customStyle={width > breakpoints.lg && 'w-max'} />
      </div>
