...
const CardProduct = () => {
  return (
    <div className="h-[26rem] w-full flex flex-col py-2 px-3 gap-2 lg:hover:bg-dark-1 lg:hover:shadow-lg [&>:nth-child(4)]:hover:flex [&>:nth-child(1)>:nth-child(1)]:hover:flex ">
      {/* LIKE AND COMPIRE ------------------------------------*/}
